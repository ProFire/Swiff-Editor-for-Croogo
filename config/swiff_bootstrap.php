 ...
 */
    Croogo::hookHelper('Nodes', 'Swiff.Swiff');
    Croogo::hookHelper('Nodes', 'Swiff.TinyMce');
    Croogo::hookHelper('Nodes', 'Javascript');
/**
 ...
 */
    //Croogo::hookAdminRowAction('Nodes/admin_index', 'Swiff Edit!', 'plugin:swiff/controller:swiff/action:swiffEdit/:id');
/**
 * Admin tab
 *
